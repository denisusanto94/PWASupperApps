<template>
  <div class="news-google mt-10 mb-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- News Content List -->
      <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4 animate-fade-in px-1">
        <div v-for="(news, index) in newsList" :key="index" class="news-premium-card group">
            <div class="flex gap-4 items-start">
                <div class="news-media-box shrink-0 overflow-hidden">
                    <img v-if="news.image" :src="news.image" :alt="news.title" class="news-image-fill scale-100 group-hover:scale-110 transition-transform duration-700" @error="news.image = null" />
                    <div v-else class="news-fallback-box">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="opacity-10"><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8"/><path d="M15 18h-5"/><path d="M10 6h8v4h-8V6Z"/></svg>
                    </div>
                </div>
